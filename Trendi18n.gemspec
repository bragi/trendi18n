...
Gem::Specification.new do |s|
  ...
  s.files = [
    "MIT-LICENSE",
     ...
     "spec/test_application/db/migrate/20091102122919_create_users.rb",
     ...
     "spec/test_application/db/test.sqlite3",
     ...
     "spec/test_application/spec/controllers/application_controller_spec.rb",
     "spec/test_application/spec/controllers/users_controller_spec.rb",
     "spec/test_application/spec/fixtures/translations.yml",
     "spec/test_application/spec/helpers/application_helper_spec.rb",
     ...
     "spec/test_application/test/fixtures/users.yml",
     "spec/test_application/test/functional/users_controller_test.rb",
     "spec/test_application/test/performance/browsing_test.rb",
     "spec/test_application/test/test_helper.rb",
     "spec/test_application/test/unit/helpers/users_helper_test.rb",
     "spec/test_application/test/unit/user_test.rb",
     "tasks/trendi18n_tasks.rake",
     "test/test_helper.rb",
     "test/trendi18n_test.rb",
     "uninstall.rb"
  ]
